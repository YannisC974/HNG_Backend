...
urlpatterns = [
    ...
    path('user-events/create/', UserEventCreateView.as_view(), name='user-event-create'),
    path('user-events/destroy/', UserEventDestroyView.as_view(), name='user-event-destroy'),
]
